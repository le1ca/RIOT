...
void isr_uart6(void)                 __attribute__ ((weak, alias("dummy_handler")));
...
const void *interrupt_vector[] = {
    ...
    dummy_handler,                      // SHA/MD5 0
    dummy_handler,                      // AES 0
    dummy_handler,                      // DES3DES 0
    dummy_handler,                      // LCD Controller 0
    dummy_handler,                      // Timer 6 subtimer A
    dummy_handler,                      // Timer 6 subtimer B
    dummy_handler,                      // Timer 7 subtimer A
    dummy_handler,                      // Timer 7 subtimer B
    dummy_handler,                      // I2C6 Master and Slave
    dummy_handler,                      // I2C7 Master and Slave
    dummy_handler,                      // HIM Scan Matrix Keyboard 0
    dummy_handler,                      // One Wire 0
    dummy_handler,                      // HIM PS/2 0
    dummy_handler,                      // HIM LED Sequencer 0
    dummy_handler,                      // HIM Consumer IR 0
    dummy_handler,                      // I2C8 Master and Slave
    dummy_handler,                      // I2C9 Master and Slave
    dummy_handler                       // GPIO Port T
};
